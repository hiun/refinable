...
Behavior.prototype.update = function (newBehavior) {
  ...
  if (typeof newBehavior === 'function') {
    ...
    throw new TypeError('Given argument is not a function nor behavior object');
  }
...
Behavior.prototype.map = function (callback) {
  if (typeof callback === 'function') {
    ...
    throw new TypeError('Given argument is not a function');
  }
  return this;
};
...
Behavior.prototype.exec = async function (...initArguments) {
